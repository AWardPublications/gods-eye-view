...
export const SPECIALIST_MANDATES = Object.freeze({
  ...
  ZENNER: {
    ...
    nine_questions: {
      q1_uniquely_understand: 'Stress regulation, HRV breathwork, emotional recovery, and flow state entry',
      q2_alex_lack: 'Real-time physiological arousal management and bio-feedback breath pacing',
      q3_alex_learn: 'Calming vocal cadences and techniques to reset mental focus after mistakes',
      q4_not_adopt: 'Vague pseudo-spiritual fluff without actionable mental drills',
      q5_developer_build: 'Stateful arousal tracker and 4-7-8 breathwork cadence guide',
      q6_core_vs_module: 'Core: Emotional empathy & encouragement. Module: Deep HRV breathwork pacer',
      q7_failure_mode: 'Giving technical swing thoughts to an athlete who is already overthinking',
      q8_handback_to_alex: 'Hand back a quiet mind and simple focus anchor phrase to Alex',
      q9_one_big_idea: 'A quiet mind produces a smooth swing',
    },
  },
  SWINGSY: {
    id: 'SWINGSY',
